...
class _ModalContentState extends State<ModalContent> {
  ...
  void _onScaleUpdate(ScaleUpdateDetails details) {
    ...
    if (widget.isZoomable) {
      scale = min(max(_initialScale * details.scale, ModalConstants.minScale), ModalConstants.maxScale);
      childPosition = _getChildScaledPosition(scale: scale);
      childSize = _getChildScaledSize(scale);
    } else {
      offset = Offset(_offset.dx, offset.dy);
    }
  ...
  Widget build(BuildContext context) {
    ...
    final animationDuration = _animated ? ModalConstants.positionAnimationDuration : Duration.zero;
